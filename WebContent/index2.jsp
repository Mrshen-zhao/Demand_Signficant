...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>文件审核</a>

  <ul>

    <li class="active"><a href="index2.jsp"><i class="icon icon-home"></i> <span>文件审核</span></a> </li>
            ...
            <table class="table table-bordered table-striped">
              ...
              <c:forEach items="${meslist}" var="mes">
                ...
                <tr class="odd gradeX">
                  ...
                  <td><a href="MessageServlet?method=find&&id=${mes.id}">查看</a></td>
