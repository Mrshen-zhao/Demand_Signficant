...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>详细信息</a>
  ...
  <ul>
    ...
    <li ><a href="MessageServlet?method=back1"
       ...
       <!-- 布局二开始 -->
        ...
        <div class="control-group" id="two">
			...
			<div class="control-group" >
              ...
              <label class="control-label">部门审核员的意见 :</label>

              <div class="controls">

                <textarea id="bmadvice"  name="bmadvice"  rows="8" placeholder="请输入您的意见"></textarea>
...
$(document).ready(function(){
	$("#ac1").focus(function(){
		...
		$("#loginform").attr('action','MessageServlet?method=bmby');
	     $("#loginform").submit();

	  });
	$("#ac2").focus(function(){
	    
		$("#loginform").attr('action','MessageServlet?method=bmnotby');
	     $("#loginform").submit();
